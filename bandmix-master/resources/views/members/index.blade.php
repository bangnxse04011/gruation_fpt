                ...
                @if($member->id == Auth::id())
                    ...
                    <div class="change-user-infor">
                        <div class="row">
                            ...
                            <div>
                                <a href="{{ route('members.manageBill',$member->id) }}"> <label class="pointer-user">Quản
                                        lý thanh toán</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="lesson-menu">
                        ...
                        <div class="menu-child">
                            ...
                            <a href="{{ route('members.manageBook',$member->id) }}"> <label class="pointer-user">Quản lý
                                    đơn hàng</label></a>
                        </div>
                    </div>
            </div>
