...
(function ($) {
	...
	$.alerts = {
		...
		confirmation: function (message, title, callback) {
			if (title == null) title = 'Alert';
			$.alerts._show(title, message, null, 'confirmation', function (result) {
				if (callback) callback(result);
			});
		},
		...
		warningConfirm: function (message, title, callback) {
			if (title == null) title = 'Confirm';
			$.alerts._show(title, message, null, 'warningConfirm', function (result) {
				if (callback) callback(result);
			});
		},
	...
	jConfirmation = function (message, title, callback) {
		$.alerts.confirmation(message, title, callback);
	}
	...
	jWarningConfirm = function (message, title, callback) {
		$.alerts.warningConfirm(message, title, callback);
	};
